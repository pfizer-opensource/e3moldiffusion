import os
from fullerene.utils import number, LoadFromCheckpoint, LoadFromFile
...
def add_arguments(parser):
    ...
    parser.add_argument("--fully-connected-layer", default=False, type=bool, help="Use full adj. layer in MPNN.")
    parser.add_argument("--local-global", default=False, type=bool, help="Use combination of local and global model.")
    ...
    parser.add_argument(
        ...
        type=str,
        default="mean",
        help="How to aggregate the vector embeddings",
    )
    parser.add_argument(
        "--include-charges",
        type=bool,
