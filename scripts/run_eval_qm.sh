...
for i in 1; do
    ...
    python experiments/run_evaluation_qm.py --model-path /scratch1/e3moldiffusion/logs/geom_qm/x0_snr_qm/best_mol_stab.ckpt --save-dir /scratch1/e3moldiffusion/logs/geom_qm/x0_snr_qm/evaluation/eval_"${i}" --save-xyz --calculate-relax-change --batch-size 70 --ngraphs 1000
    #--use-energy-guidance --ckpt-energy-model /scratch1/e3moldiffusion/logs/geom/energy_training_snr/run0/best.ckpt
