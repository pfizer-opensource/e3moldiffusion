...
#SBATCH --nodelist=ondemand-8xv100m32-1a-dy-node-2
##SBATCH --gres=gpu:4
...
# python run_train.py --conf /sharedhome/let55/projects/e3moldiffusion/configs/diffusion_qm9.yaml
# python run_train.py --conf /hpfs/userws/let55/projects/e3moldiffusion/configs/diffusion_qm9.yaml