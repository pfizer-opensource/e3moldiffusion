...
#SBATCH --gres=gpu:8
#SBATCH --output=/sharedhome/let55/projects/e3moldiffusion/experiments/geom/slurm_outs/drugs_experiment_%j.out
#SBATCH --error=/sharedhome/let55/projects/e3moldiffusion/experiments/geom/slurm_outs/drugs_experiment_%j.err
