...
#SBATCH --gres=gpu:1 
#SBATCH --output=/home/let55/workspace/projects/e3moldiffusion/geom/slurm_outs/qm9_full_%j.out
#SBATCH --error=/home/let55/workspace/projects/e3moldiffusion/geom/slurm_outs/qm9_full_%j.err
...
args=(
    ...
    --save_dir logs/qm9
    --num_epochs 100
    --sdim 64 --vdim 16 --tdim 64 --edim 0 --rbf_dim 16 --num_layers 4 
    --cutoff 7.5
    --lr 5e-4
    --batch_size 256
    --local_global_model
