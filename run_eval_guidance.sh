...
for i in 1; do
    echo "${i}"
    mkdir /scratch1/e3moldiffusion/logs/geom/x0_snr_t_weighting/polarizability/minimize_polar_scale100_steps250_relax20
    ...
    --save-dir /scratch1/e3moldiffusion/logs/geom/x0_snr_t_weighting/polarizability/minimize_polar_scale100_steps250_relax20 \
    --save-xyz \
    --save-traj \
    --calculate-props \
    --fix-noise-and-nodes \
