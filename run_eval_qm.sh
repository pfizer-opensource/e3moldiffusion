...
for i in 0; do
    echo "${i}"
    mkdir /scratch1/e3moldiffusion/logs/geom_qm/x0_snr_5conf_lc2_homo_lumo/evaluation/eval_"${i}"
    python experiments/run_evaluation_qm.py --model-path /scratch1/e3moldiffusion/logs/geom_qm/x0_snr_5conf_lc2_homo_lumo/best_mol_stab.ckpt --save-dir /scratch1/e3moldiffusion/logs/geom_qm/x0_snr_5conf_lc2_homo_lumo/evaluation/eval_"${i}" --save-xyz --calculate-props --batch-size 70 --ngraphs 1000
