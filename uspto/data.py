...
from uspto.dataset import USPTO
from uspto.utils import make_splits, MissingEnergyException
from torch_scatter import scatter


class USPTODataModule(LightningDataModule):
    def __init__(self, hparams, dataset=None):
        super(USPTODataModule, self).__init__()
    ...
    def setup(self, stage):
        dataset = (
            USPTO if self.hparams["dataset"] == "uspto" else self.hparams["dataset"]
        )
        self.dataset = dataset(
