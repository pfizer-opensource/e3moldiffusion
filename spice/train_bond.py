...
from spice.analyze_sampling import SamplingMetrics
from spice.info_data import SPICEInfos
from spice.utils_metrics import batch_to_list
from spice.utils_sampling import (
    sanitize_molecules_openbabel,
    check_stability_given_bonds,
    Molecule,
)
from spice.utils import PlaceHolder
from spice.visualize_bonds import visualize_mol, visualize_chain, visualize
...
class Trainer(pl.LightningModule):
    ...
    def compute_x_pred(self, net_out, edge_out, z_t, edge_t, gamma_t, data_batch):
        ...
        if self.parametrization == "x":
            ...
            bond_pred = 1.0 / alpha_t * (edge_t - sigma_t * edge_out)
        else:
    ...
    def sample_p_xh_given_z0(
        ...
        dense_edge_oh = self.sample_symmetric_edge_normal(mu_bond)
    ...
    def compute_loss(
        ...
        dense_edge_oh_t = alpha_t * dense_edge_oh + sigma_t * noise_edge_oh
        ...
        if t0_always:
            ...
            dense_edge_oh_t0 = alpha_t * dense_edge_oh + sigma_t * noise_edge_oh_0
    ...
    def sample_p_zs_given_zt(
        ...
        mu_edge = (
            dense_edge_t / alpha_t_given_s
            - (sigma2_t_given_s / alpha_t_given_s / sigma_t) * eps_edge_t
        )
...
if __name__ == "__main__":
    from spice.data import SPICEDataModule
    from spice.hparams import add_arguments
    ...
    datamodule = SPICEDataModule(hparams)
    datamodule.prepare_data()
    datamodule.setup("fit")

    dataset_statistics = SPICEInfos(datamodule.dataset)
