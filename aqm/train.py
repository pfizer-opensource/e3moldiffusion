...
from aqm.utils import _collate
    ...
    def sample_sweep_conditional(
        ...
        *  Several options:
            - single-property: Output n_frames molecules for which the property is interpolated between min and max (not meant for multi-property guidance!)
                - default
            - multi-property: Output a coherent interpolation chain for one property between min/max values or a given range, while others are fixed, but which potentially contains invalid molecules and dimers
