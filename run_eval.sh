...
for i in 4; do
    echo "${i}"
    mkdir /hpfs/userws/cremej01/projects/logs/geom/x0_retraining_0_snr_t_snr_t_weighting/evaluation/eval_"${i}"
    ...
    python experiments/run_evaluation.py --model-path /hpfs/userws/cremej01/projects/logs/geom/x0_retraining_0_snr_t_snr_t_weighting/best_mol_stab.ckpt --save-dir /hpfs/userws/cremej01/projects/logs/geom/x0_retraining_0_snr_t_snr_t_weighting/evaluation/eval_"${i}" --save-xyz --calculate-energy --batch-size 80 --ngraphs 1000
