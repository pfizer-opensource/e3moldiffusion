...
def add_arguments(parser):
    ...
    parser.add_argument("--not-strict-ckpt", default=False, action="store_true")
    ...
    parser.add_argument("--sdim-latent", default=128, type=int)
    parser.add_argument("--vdim-latent", default=32, type=int)
    parser.add_argument("--latent-dim", default=None, type=int)
    parser.add_argument("--edim-latent", default=16, type=int)
    parser.add_argument("--num-layers-latent", default=8, type=int)
    parser.add_argument("--latentmodel", default="mmd", type=str)
    parser.add_argument("--latent-detach", default=False, action="store_true")
    parser.add_argument("--use-pos-norm-latent", default=False, action="store_true")
    parser.add_argument("--use-out-norm-latent", default=False, action="store_true")
