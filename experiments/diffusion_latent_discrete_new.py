...
class Trainer(pl.LightningModule):
    def __init__(self,
        ...
        self.latent_score_net = nn.Sequential(
            DenseLayer(hparams["latent_dim"] + 1, hparams["latent_dim"], activation=nn.SiLU()),
    ...
    def step_fnc(self, batch, batch_idx, stage: str):
        ...
        self._log(final_loss, loss["coords"], loss["atoms"], loss["charges"], loss["bonds"], latent_loss, batch_size, stage)
    ...
    def forward(self, batch: Batch, t: Tensor):
        ...
        mean_z, std_z = self.sde.marginal_prob(x=z.detach(), t=t)
        # perturb latent
    ...
    def reverse_sampling(
        ...
        for timestep in iterator:
            t = torch.full(size=(bs, ), fill_value=timestep, dtype=torch.long, device=z.device)
            ...
            # update fnc
            # latents
            mean = sqrt_alphas * one_m_alphas_cumprod_prev * z + \
    ...
    def _log(self, loss, coords_loss, atoms_loss, charges_loss, bonds_loss, latent_loss, batch_size, stage):
        self.log(
            f"{stage}/loss",
            loss,
            on_step=True,
